 ...
 */
final class Version20251026221555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE measurement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, location_id INTEGER DEFAULT NULL, date DATE NOT NULL, celsius NUMERIC(3, 0) NOT NULL, temperature DOUBLE PRECISION DEFAULT NULL, humidity INTEGER DEFAULT NULL, measuremed_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
